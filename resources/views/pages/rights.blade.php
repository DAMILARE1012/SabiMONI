        ...
        <div class="col-md-6" style="background-color: #29ca8e; color:white; padding: 20px 40px; margin-top:40px;">
            <h3>Responsibilities of the Central Bank Of Nigeria</h3>
                <p style="margin-top: 10px; color:white;">
                    One of the core mandates of the Central bank of Nigeria (CBN) is to ensure Financial System Stability. The role
                    of the
                ...
                <ol style="margin-top: 15px; margin-bottom:30px;">
                    <li>Consumers are equipped with adequate Financial Education to increase their financial Literacy and Capability
                    </li>
                    <li>
                    ...
                    <li>
                        Fair and responsible Business Conduct amongst Financial Institutions under the regulatory purview of the
                        CBN.
                    </li>        
                </ol>
        </div>
